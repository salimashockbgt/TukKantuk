...
import com.example.tukkantuk.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val dicodingSpace = LatLng(-6.880574068069173, 107.60417083841581)
        mMap.addMarker(
            MarkerOptions().position(dicodingSpace).title("Titik Berhenti")
                .snippet("Saya ngantuk")
        )
    ...
    private fun addManyMarker() {
        ...
        viewModel.getStoriesWithLocation().observe(this) { value ->
            if (value != null) {
                when (value) {
                    is Result.Loading -> {
                    }
